...
public class ViewUser {
    ...
    private void update() throws Exception {
        ...
        String field_name = prompt("Какой параметр изменяем (NAME, SURNAME, TELEPHONE): ");
        String param = null;
        if (Fields.valueOf(field_name) == Fields.TELEPHONE) {
            ...
            param = prompt("Изменяемый параметр:  ");
        }
        ...
        while(true) {
            try {
                ...
                if(telephone.equals("0")) {
                    System.out.println("Вы отказались от изменения данных пользователя");
                    return null;
                }
    ...
    private void delete() throws Exception {
            String userid = prompt("Введите ID для удаления: ");
            User _user = userController.readUser(userid);
